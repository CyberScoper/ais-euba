...
const SK = {
  ...
  'app.logout': 'Odhlásiť',
  'app.menu': 'Nastavenia',
  'app.install': 'Nainštalovať aplikáciu',
  'app.installIos': 'Na iPhone: Zdieľať → Pridať na plochu.',
  'app.installed': 'Aplikácia je nainštalovaná',
  'app.language': 'Jazyk',
...
const RU = {
  ...
  'app.installIos': 'На iPhone: «Поделиться» → «На экран „Домой“».',
...
const UK = {
  ...
  'app.installIos': 'На iPhone: «Поділитися» → «На екран „Початок“».',
  'app.installed': 'Застосунок встановлено',
  'app.language': 'Мова',
...
const EN = {
  ...
  'app.installIos': 'On iPhone: Share → Add to Home Screen.',
  'app.installed': 'The app is installed',
